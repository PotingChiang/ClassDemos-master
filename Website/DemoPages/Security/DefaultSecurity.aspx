...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
            ...
            <asp:ListView ID="UserListView" runat="server"
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                        ...
                        </td><asp:ListView ID="UserListView" runat="server"
                            ItemType="eRestaurantSystem.Entities.Security.ApplicationUser"
                            OnItemCommand="UserListView_ItemCommand">
                            <EmptyDataTemplate>
                                <table runat="server">
                                    <tr>
                                        <td>
                                            No users in this site.
                                            <asp:LinkButton runat="server" CommandName="AddWaiters" Text="Add Waiters as users" 
                                                ID="AddWaitersButton" />
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <LayoutTemplate>
                                <table runat="server">
                                    ...
                                    <tr runat="server">
                                        <td runat="server">
                                           <%-- Add the page controlID (pointers to ListView ID)
                                            ...
                                            <asp:DataPager runat="server" ID="DataPagerUsers"
                                                ...
                                                OnPreRender="DataPagerUsers_PreRender"
                                                PageSize="3">
                                                <Fields>
    ...
    <asp:ObjectDataSource runat="server" ID="WaiterDataSource" OldValuesParameterFormatString="original_{0}"  
        TypeName="eRestaurantSystem.BLL.eRestaurantController" SelectMethod="ListWaiters"></asp:ObjectDataSource>
</asp:Content>
